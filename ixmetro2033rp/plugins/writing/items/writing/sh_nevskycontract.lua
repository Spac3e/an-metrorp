...
ITEM.name = "Nevsky Prospekt Contract"
ITEM.description = "A piece of paper with the Nevsky Prospekt Crest painted on it."
ITEM.price = 2
ITEM.model = Model("models/z-o-m-b-i-e/metro_2033/d6_items/m33_tech_book_01.mdl")
ITEM.width = 1
ITEM.height = 1
ITEM.business = true
