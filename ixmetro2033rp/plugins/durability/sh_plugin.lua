...
ix.config.Add("maxValueDurability", 200, "Maximum value of the durability.", nil, {
	data = {min = 1, max = 9999},
	category = PLUGIN.name
})

ix.config.Add("decDurability", 0.0001, "By how many units do reduce the durability with each shot?", nil, {
	data = {min = 0.00001, max = 200, decimals = 5},
	category = PLUGIN.name
})
